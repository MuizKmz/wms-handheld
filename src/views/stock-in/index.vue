    ...
    <scroll-view class="scroll-container" scroll-y="true">
      ...
      <view class="form-section">
        <view class="section-header">
          <text class="section-title">Stock In Details</text>
...
import StockInImg from '@/static/stock-in.png'
...
export default {
  ...
  computed: {
    ...
    pageTitle() {
      if (this.stockInForm.inboundType === 3) {
        return 'Stock In - Return'
      } else {
        return this.epcMode ? 'Stock In - EPC' : 'Stock In - TID'
      }
    },
    topImg() {
      // inboundType:3 return
      return this.stockInForm.inboundType === 3 ? ReturnImg : StockInImg
    },
  },
  watch: {},
  ...
  methods: {
    ...
    ...mapActions(useStockStore, {cancel: 'cancelStockInAction'}),
    async onDoNumberChange() {
    },
    onCancel() {
      this.cancel()
      this.$msg('Stock in reset')
    },
