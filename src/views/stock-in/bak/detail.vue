<template>
  <!-- Header Component -->
  <HeaderComponent :showBack="true" :showLogOut="true" :showNotification="true" pageTitle="Stock In"/>
  <!--<wms-nav-bar title="Stock In Details" left-icon="arrow-left" @click-left="goBack"></wms-nav-bar>-->

  <div class="image-wrapper">
    <div class="image-container">
      <image alt="Search" src="/static/stock-in.png"/>
    </div>
  </div>
  ...
  <view class="details-container">
    <view class="header-info">
      ...
      <view class="header-row">
        <text class="header-label">TYPE:</text>
        <text class="header-value">{{ stockInData.stockType || '-' }}</text>
      </view>

      <view class="header-row">
        <text class="header-label">Warehouse:</text>
        <text class="header-value">{{ stockInData.warehouse || '-' }}</text>
      </view>
      <view class="header-row">
        <text class="header-label">Rack:</text>
        <text class="header-value">{{ stockInData.rack || '-' }}</text>
      </view>
      <view class="header-row">
        <text class="header-label">Section:</text>
        <text class="header-value">{{ stockInData.section || '-' }}</text>
      </view>
      <view class="header-row">
    ...
    <scroll-view class="table-container" scroll-y="true">
      <view class="table-header">
        ...
        <text class="header-cell epc-code">EPC CODE</text>
