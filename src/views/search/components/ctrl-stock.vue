<template>
  <view class="action-section">
    <up-row class="action-buttons" gutter="10" justify="center">
      <up-col span="4">
        <up-button :disabled="searchTags.length <= 0" :text="inventoryText" :throttleTime="1000" icon="tags"
                   shape="circle" size="small"
                   type="success"
                   @click="inventoryTrigger"></up-button>
      </up-col>
      <up-col span="4">
        <up-button :disabled="searchTags.length <= 0" :throttleTime="1000" icon="scan" shape="circle" size="small"
                   text="SCAN QR"
                   type="warning"
                   @click="onScanCode"></up-button>
      </up-col>
      <up-col span="4">
        <up-button :disabled="searchTags.length <= 0" :throttleTime="1000" icon="home" shape="circle" size="small"
                   text="RETURN"
                   type="primary"
