    ...
    <scroll-view class="scroll-container" scroll-y="true">
      <view class="details-section">
        <view class="form-item">
          <text class="label">DO No. / Order No.:</text>
          <up-input v-model="doNumber" border="none" class="input-field" placeholder=" Key in"></up-input>
        </view>
...
export default {
  ...
  methods: {
    ...
    viewDetails() {
      ...
      uni.navigateTo({
        url: `/views/detail-out?data=${encodeURIComponent(JSON.stringify(this.lastConfirmedData))}`
      })
    },
    saveConfirmedData() {
      try {
